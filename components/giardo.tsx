...
export default function Giardo(props: any) {
  ...
  const Content = () => {
    return (
      <Link href="https://www.giardo-eventgarten.ch">
        <img src="https://www.giardo-eventgarten.ch/app/uploads/2023/04/Giardo_Logo_neg.svg" />
      </Link>
    );
  };
  return (
    <div ref={ref}>
      {props.inView >= 6 ? (
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 7.6 }}
        >
          <Content />
        </motion.div>
      ) : (
